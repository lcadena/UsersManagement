...
export class RegisterComponent implements OnInit {
  ...
  register() {
    ...
    const user = new User( this.registerForm.value.email, this.registerForm.value.firstName,
      this.registerForm.value.lastName, this.registerForm.value.password, '', '', null
